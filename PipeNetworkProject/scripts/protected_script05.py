...
output_path = os.path.join(base_path, "output", "filtered_groups.json")
...
# Logic: filter by structure count > 1
valid_indexes = [i for i, count in enumerate(structure_counts) if count > 1]
